...
Ilustração de uma rede ponto a ponto (P2P):<br>
<img src="imagens/p2p-rede.png" width="500"><br>
...
Ilustração de uma rede Cliente-Servidor (Client-Server):<br>
<img src="imagens/cliente-servidor.jpeg" width="500"><br>